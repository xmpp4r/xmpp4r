...
This fork exists to facilitate the development of Switchboard and
Dovetail until the next official release of xmpp4r:

* http://github.com/mojodna/switchboard
* http://github.com/mojodna/dovetail
...
* ripta/chat-state-notification - Chat State Notification (XEP-0085)
